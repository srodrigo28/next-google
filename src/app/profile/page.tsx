        ...
        (
            <div className="bg-black h-screen text-white p-10 flex gap-9 flex-col ">
                 <div className="bg-zinc-900 rounded-md w-96 h-96 flex gap-5 flex-col 
                    ...
                    <img className="rounded-full absolute top-44" width={150} src={`${user.image}`} alt="" />
                 ...
                 <div className="bg-zinc-900 rounded-lg w-96 h-96 flex gap-5 flex-col 
                    ...
                    <form action={ async () => { "use server"; await signIn("google") } }>
                        <button className="bg-blue-700 px-10 p-2 rounded-md animate-pulse flex gap-3 items-center">
                            <img width={30} src="https://upload.wikimedia.org/wikipedia/commons/thumb/e/e1/Google_Chrome_icon_%28February_2022%29.svg/768px-Google_Chrome_icon_%28February_2022%29.svg.png" alt="" />
                            Sign in
                        </button>
                    </form>
                </div>
